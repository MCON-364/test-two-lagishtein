...
public class ParallelReportBuilder {
    ...
    public ReportSummary generateReport(List<List<Transaction>> batches, int workers)
        ...
        if (batches == null || batches.isEmpty()) {
            throw new IllegalArgumentException("Batches should be provided");
        }
       ...
       return new ReportSummary(totalAmount, totalCount, globalMax, globalMin, getProcessedBatchCount());
    }
